...
export class CommentsController {
    ...
    @ApiOperation({
        ...
        description: 'Retorna todos los comentarios de una publicación específica, ordenados por fecha (más recientes primero)'
    })
    ...
    @ApiParam({ name: 'postId', description: 'ID de la publicación' })
    @ApiResponse({ status: 200, description: 'Cantidad de comentarios', schema: { example: 5 } })
    ...
    @ApiOperation({
        ...
        description: 'Crea un nuevo comentario en una publicación. Requiere autenticación.'
    })
    @ApiParam({ name: 'postId', description: 'ID de la publicación' })
    ...
    @ApiOperation({
        ...
        description: 'Actualiza un comentario existente. Solo el autor puede editar su comentario.'
    })
    @ApiParam({ name: 'postId', description: 'ID de la publicación' })
    ...
    @ApiOperation({
        ...
        description: 'Elimina un comentario existente. Solo el autor puede eliminar su comentario.'
    })
    @ApiParam({ name: 'postId', description: 'ID de la publicación' })
    @ApiParam({ name: 'id', description: 'ID del comentario' })
